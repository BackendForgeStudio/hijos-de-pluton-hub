...
// NUEVO COMPONENTE: Efecto de texto desencriptado
const TextoDesencriptado = ({ text }: { text: string }) => {
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      ...
      iteration += 1 / 2; // Controla la velocidad (más alto = más rápido)
    }, 30);
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className="relative z-10 p-8 md:p-10">
                  ...
                  {/* Notas del Custodio (AHORA CON EFECTO DESENCRIPTADO) */}
                  <div className="bg-[#100A14] p-5 border-l-4 border-[#C8946E] mb-8 relative z-10 shadow-inner">
                    ...
                    <p className="font-mono text-xs text-[#C8946E] leading-relaxed opacity-90 min-h-[60px]">
